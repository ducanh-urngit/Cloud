...
/**
 * Servlet implementation class DeleteLoaiSPController
 */
@WebServlet("/xoa-loai-san-pham-admin")
public class DeleteLoaiSPController extends HttpServlet {
