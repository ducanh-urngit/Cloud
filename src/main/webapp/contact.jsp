...
<body>
 ...
 <!-- end header -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Địa chỉ</h4>
                        <p>Số 1 Võ Văn Ngân, Tp Thủ Đức</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
    ...
    <div class="map">
        <!-- <iframe
            src="https://www.google.com/maps/place/Tr%C6%B0%E1%BB%9Dng+%C4%90%E1%BA%A1i+h%E1%BB%8Dc+S%C6%B0+ph%E1%BA%A1m+K%E1%BB%B9+thu%E1%BA%ADt+Tp.+H%E1%BB%93+Ch%C3%AD+Minh/@10.8507267,106.7697282,17z/data=!4m5!3m4!1s0x31752763f23816ab:0x282f711441b6916f!8m2!3d10.8507214!4d106.7719223"
            height="500" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe> -->
            <img src="img/map.png" alt="">
        <div class="map-inside">
            <!-- <i class="icon_pin"></i> -->
            <div class="inside-widget">
                <h4>Trường Đại học Sư phạm Kỹ thuật Tp.Hồ Chí Minh</h4>
                <ul>
                    <li>Điện thoại: +84 18.04.2002</li>
                    <li>Địa Chỉ: 1 Đ. Võ Văn Ngân, Linh Chiểu, Thành Phố Thủ Đức, Thành phố Hồ Chí Minh, Việt Nam</li>
                </ul>
            </div>
        </div>
    </div>
