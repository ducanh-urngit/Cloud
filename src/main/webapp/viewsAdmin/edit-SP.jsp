...
<div class="wrapper">
 ...
 <!-- end header -->
<form action="xac-nhan-sua-san-pham-admin">
    <div class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="content table-responsive table-full-width">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <input name="maSP" type="hidden" class="col-md-12 form-control border-input" placeholder="" value="${sp.getMaSP()}">
                                    </tr>
                                    <tr>
                                        ...
                                        <td> 
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input name="tenSP" type="text" class="col-md-12 form-control border-input" placeholder="" value="${sp.getTenSP()}">
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input name="Gia" type="number" class="col-md-12 form-control border-input" placeholder="" value="${sp.getGiaSP()}">
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input name="soLuong" type="number" class="col-md-12 form-control border-input" placeholder="" value="${sp.getSoLuongTonKho()}">
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input name="giamGia" type="number" class="col-md-12 form-control border-input" placeholder="" value="${sp.getGiamGia()}">
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input name="moTa" type="text" class="col-md-12 form-control border-input" placeholder="" value="${sp.getMoTaSP()}">
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input name="ngay" type="text" class="col-md-12 form-control border-input" placeholder="" value="${sp.getNgayNhapHang()}">
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>
    ...
    <div class="text-center" style="margin-bottom:30px;">
        <button type="submit" class="btn btn-info btn-fill btn-wd">Xác nhận lưu</button>
    </div>
 </form>   
<!-- footer -->  
